...
import { View, Text, Dimensions, Modal, TouchableOpacity, DatePickerIOS, Linking } from 'react-native';
...
class SingleEventView extends Component {
  ...
  onApplyNewDate() {
    ...
    this.props.setEventTimestamp(this.props.event, this.state.date.valueOf());
  }
  onCancel(event) {
